# core/migrations/XXXX_popular_catalogo_atividades.py

from django.db import migrations

# Dados extraídos da Resolução CONSU Nº 67, de 28 de julho de 2023
ATIVIDADES = [
    # a) Instrutoria
    ...
    {"grupo": "Logistica", "nome": "Supervisão (Logística)", "valor_hora": 60.47},
    ...
    {"grupo": "Aplicacao", "nome": "Supervisão (Aplicação de Prova)", "valor_hora": 44.69},
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0006_alter_servidorprofile_funcao'),
    ]
